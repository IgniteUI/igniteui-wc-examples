...
defineComponents(IgcAccordionComponent, IgcCheckboxComponent, IgcRangeSliderComponent, IgcRadioGroupComponent, IgcRadioComponent, IgcRatingComponent, IgcIconComponent, IgcDateTimeInputComponent);
