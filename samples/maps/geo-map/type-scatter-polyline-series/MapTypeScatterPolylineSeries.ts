...
export class MapTypeScatterPolylineSeries extends SampleBase {

    public static htmlTagName: string = SampleBase.tag("MapTypeScatterPolylineSeries");
    public static register(): any {
        window.customElements.define(this.htmlTagName, MapTypeScatterPolylineSeries); return this;
    }
