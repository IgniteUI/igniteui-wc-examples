...
export class MapTypeScatterContourSeries extends SampleBase {

    public static htmlTagName: string = SampleBase.tag("MapTypeScatterContourSeries");
    public static register(): any {
        window.customElements.define(this.htmlTagName, MapTypeScatterContourSeries); return this;
    }
