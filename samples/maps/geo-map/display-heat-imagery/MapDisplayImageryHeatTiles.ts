...
export class MapDisplayImageryHeatTiles extends SampleBase {

    public static htmlTagName: string = SampleBase.tag("MapDisplayImageryHeatTiles");
    public static register(): any {
        window.customElements.define(this.htmlTagName, MapDisplayImageryHeatTiles); return this;
    }
