...
export class MapCustomTooltips extends SampleBase {

    public static htmlTagName: string = SampleBase.tag("MapCustomTooltips");
    public static register(): any {
        window.customElements.define(this.htmlTagName, MapCustomTooltips); return this;
    }
