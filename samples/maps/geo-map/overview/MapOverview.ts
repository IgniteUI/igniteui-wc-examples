...
export class MapOverview extends SampleBase {

    public static htmlTagName: string = SampleBase.tag("MapOverview");
    public static register(): any {
        window.customElements.define(this.htmlTagName, MapOverview); return this;
    }
