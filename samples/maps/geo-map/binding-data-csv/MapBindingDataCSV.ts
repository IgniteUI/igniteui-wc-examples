...
export class MapBindingDataCSV extends SampleBase {

    public static htmlTagName: string = SampleBase.tag("MapBindingDataCSV");
    public static register(): any {
        window.customElements.define(this.htmlTagName, MapBindingDataCSV); return this;
    }
