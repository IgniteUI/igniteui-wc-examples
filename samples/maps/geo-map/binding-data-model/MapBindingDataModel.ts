...
export class MapBindingDataModel extends SampleBase {

    public static htmlTagName: string = SampleBase.tag("MapBindingDataModel");
    public static register(): any {
        window.customElements.define(this.htmlTagName, MapBindingDataModel); return this;
    }
