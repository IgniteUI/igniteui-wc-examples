...
<div class="sample-container">
    <div class="workbook-operations">
        <button id="button1">Save Workbook</button>
    </div>
    <div class="cell-features">
        <label class="label">Add a Comment to cell A1: </label>
        <input type="checkbox" id="addComment"></input> <br/>
        <label class="label">Add a Formula for cells F2 to F20: </label>
        <input type="checkbox" id="addFormula"></input>  <br/>
        <label class="label">Merge Cells: </label>
        <input type="checkbox" id="mergeCells"></input>
    </div>
</div>
`;

export class ExcelLibraryCells extends SampleBase {

    public static htmlTagName: string = SampleBase.tag("ExcelLibraryCells");
    public static register(): any {
        window.customElements.define(this.htmlTagName, ExcelLibraryCells); return this;
    }
