...
export class ExcelLibraryOverview extends SampleBase {

    public static htmlTagName: string = SampleBase.tag("ExcelLibraryOverview");
    public static register(): any {
        window.customElements.define(this.htmlTagName, ExcelLibraryOverview); return this;
    }
