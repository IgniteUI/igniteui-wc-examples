...
<div class="sample-container">
    <div class="options">
        <button class="option-item" id="exportBtn">Export</button>
    </div>
    <igc-data-grid id="grid" auto-generate-columns="false" height="calc(100% - 45px)" width="100%">
        <igc-template-column id="templateColumn" property-path="Orders"></igc-template-column>
        <igc-text-column property-path="CompanyName"></igc-text-column>
        <igc-text-column property-path="ContactName"></igc-text-column>
        <igc-text-column property-path="ContactTitle"></igc-text-column>
        <igc-text-column property-path="Country"></igc-text-column>
    </igc-data-grid>
</div>
`;

export class ExcelLibrarySparklines extends SampleBase {

    public static htmlTagName: string = SampleBase.tag("ExcelLibrarySparklines");
    public static register(): any {
        window.customElements.define(this.htmlTagName, ExcelLibrarySparklines); return this;
    }
