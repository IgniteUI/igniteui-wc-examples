...
<div class="sample-container">
    <div class="options">
        <button class="option-item" id="createBtn">Create Workbook</button>
        <button class="option-item" id="saveBtn">Save Workbook</button>
        <span class="option-item">Select Table to Export: </span>
...
export class ExcelLibraryWorkbooks extends SampleBase {

    public static htmlTagName: string = SampleBase.tag("ExcelLibraryWorkbooks");
    public static register(): any {
        window.customElements.define(this.htmlTagName, ExcelLibraryWorkbooks); return this;
    }
