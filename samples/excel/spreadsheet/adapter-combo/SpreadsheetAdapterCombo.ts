...
export class SpreadsheetAdapterCombo extends SampleBase {

    public static htmlTagName: string = SampleBase.tag("SpreadsheetAdapterCombo");
    public static register(): any {
        window.customElements.define(this.htmlTagName, SpreadsheetAdapterCombo); return this;
    }
