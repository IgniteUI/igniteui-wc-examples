...
import { WorksheetColumnWidthUnit } from 'igniteui-webcomponents-excel';
...
export class SpreadsheetDataValidation extends SampleBase {

    public static htmlTagName: string = SampleBase.tag("SpreadsheetDataValidation");
    public static register(): any {
        window.customElements.define(this.htmlTagName, SpreadsheetDataValidation); return this;
    }
