...
export class SpreadsheetConditionalFormatting extends SampleBase {

    public static htmlTagName: string = SampleBase.tag("SpreadsheetConditionalFormatting");
    public static register(): any {
        window.customElements.define(this.htmlTagName, SpreadsheetConditionalFormatting); return this;
    }
