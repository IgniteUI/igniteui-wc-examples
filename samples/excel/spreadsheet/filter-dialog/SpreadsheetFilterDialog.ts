...
export class SpreadsheetFilterDialog extends SampleBase {

    public static htmlTagName: string = SampleBase.tag("SpreadsheetFilterDialog");
    public static register(): any {
        window.customElements.define(this.htmlTagName, SpreadsheetFilterDialog); return this;
    }
