...
export class SpreadsheetAdapter extends SampleBase {

    public static htmlTagName: string = SampleBase.tag("SpreadsheetAdapter");
    public static register(): any {
        window.customElements.define(this.htmlTagName, SpreadsheetAdapter); return this;
    }
