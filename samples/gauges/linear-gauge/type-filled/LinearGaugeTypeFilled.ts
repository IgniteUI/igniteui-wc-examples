...
export class LinearGaugeTypeFilled extends SampleBase {

    public static htmlTagName: string = SampleBase.tag("LinearGaugeTypeFilled");
    public static register(): any {
        window.customElements.define(this.htmlTagName, LinearGaugeTypeFilled); return this;
    }
