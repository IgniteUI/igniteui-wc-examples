...
<div class="sampleRows">
    <igc-linear-gauge id="gauge" height="120px" width="100%">
    </igc-linear-gauge>
</div>
`;

export class LinearGaugeTypeCurve extends SampleBase {

    public static htmlTagName: string = SampleBase.tag("LinearGaugeTypeCurve");
    public static register(): any {
        window.customElements.define(this.htmlTagName, LinearGaugeTypeCurve); return this;
    }
    ...
    public renderGauge(gauge: IgcLinearGaugeComponent) {
        ...
        for (let i = 0; i < colors.length; i++) {
            ...
            const upperCurve = new IgcLinearGraphRangeComponent();
