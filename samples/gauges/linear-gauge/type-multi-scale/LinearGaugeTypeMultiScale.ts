...
export class LinearGaugeTypeMultiScale extends SampleBase {

    public static htmlTagName: string = SampleBase.tag("LinearGaugeTypeMultiScale");
    public static register(): any {
        window.customElements.define(this.htmlTagName, LinearGaugeTypeMultiScale); return this;
    }
