...
export class RadialGaugeTypeSemi extends SampleBase {

    public static htmlTagName: string = SampleBase.tag("RadialGaugeTypeSemi");
    public static register(): any {
        window.customElements.define(this.htmlTagName, RadialGaugeTypeSemi); return this;
    }
