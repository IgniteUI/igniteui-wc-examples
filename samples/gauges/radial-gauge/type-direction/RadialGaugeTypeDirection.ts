...
export class RadialGaugeTypeDirection extends SampleBase {

    public static htmlTagName: string = SampleBase.tag("RadialGaugeTypeDirection");
    public static register(): any {
        window.customElements.define(this.htmlTagName, RadialGaugeTypeDirection); return this;
    }
