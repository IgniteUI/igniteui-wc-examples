...
export class RadialGaugeTypeHalf extends SampleBase {

    public static htmlTagName: string = SampleBase.tag("RadialGaugeTypeHalf");
    public static register(): any {
        window.customElements.define(this.htmlTagName, RadialGaugeTypeHalf); return this;
    }
