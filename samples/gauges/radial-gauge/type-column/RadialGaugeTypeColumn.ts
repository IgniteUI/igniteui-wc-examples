...
export class RadialGaugeTypeColumn extends SampleBase {

    public static htmlTagName: string = SampleBase.tag("RadialGaugeTypeColumn");
    public static register(): any {
        window.customElements.define(this.htmlTagName, RadialGaugeTypeColumn); return this;
    }
