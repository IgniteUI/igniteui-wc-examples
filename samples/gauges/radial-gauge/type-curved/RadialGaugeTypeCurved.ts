...
<div class="sampleRows">
    <igc-radial-gauge id="gauge" width="100%" height="100%">
    </igc-radial-gauge>
</div>
`;

export class RadialGaugeTypeCurved extends SampleBase {

    public static htmlTagName: string = SampleBase.tag("RadialGaugeTypeCurved");
    public static register(): any {
        window.customElements.define(this.htmlTagName, RadialGaugeTypeCurved); return this;
    }
