...
export class RadialGaugeTypeRing extends SampleBase {

    public static htmlTagName: string = SampleBase.tag("RadialGaugeTypeRing");
    public static register(): any {
        window.customElements.define(this.htmlTagName, RadialGaugeTypeRing); return this;
    }
