...
export class RadialGaugeTypeFull extends SampleBase {

    public static htmlTagName: string = SampleBase.tag("RadialGaugeTypeFull");
    public static register(): any {
        window.customElements.define(this.htmlTagName, RadialGaugeTypeFull); return this;
    }
