...
<div class ="sampleRows">
    <div className="options">
        <button id="button1" class="button">Gauge Animation #1</button>
        <button id="button2" class="button">Gauge Animation #2</button>
        <button id="button3" class="button">Gauge Animation #3</button>
        <button id="button4" class="button">Gauge Animation #4</button>
    </div>
    ...
    <igc-radial-gauge
        ...
        label-extent="0.71"
        minor-tickCount="4"
        minor-tick-end-extent=".625"
        minor-tick-start-extent=".6"
        minor-tick-stroke-thickness="1"
        minor-tick-brush = "#79797a"
        tick-start-extent=".6"
        tick-end-extent=".65"
        tick-stroke-thickness="2"
        tick-brush="#79797a"
        needle-shape="Triangle"
        needle-end-width-ratio="0.03"
        needle-start-width-ratio="0.05"
        needle-pivot-shape="CircleOverlay"
        needle-pivot-width-ratio="0.15"
        needle-base-feature-width-ratio="0.15"
        needle-brush="#79797a"
        needle-outline="#79797a"
        needle-pivot-brush="#79797a"
        needle-pivot-outline="#79797a"
        is-needle-dragging-enabled="true"
        backing-brush="#fcfcfc"
        backing-outline="#d6d6d6"
        backing-stroke-thickness="5"
        scale-start-angle="120"
        scale-end-angle="60"
        scale-brush="#d6d6d6"
        range-brushes="#F86232, #DC3F76, #7446B9"
        range-outlines="#F86232, #DC3F76, #7446B9" >
    </igc-radial-gauge>
</div>
`;

export class RadialGaugeAnimation extends SampleBase {

    public static htmlTagName: string = SampleBase.tag("RadialGaugeAnimation");
    public static register(): any {
        window.customElements.define(this.htmlTagName, RadialGaugeAnimation); return this;
    }
