...
export class RadialGaugeTypeQuatre extends SampleBase {

    public static htmlTagName: string = SampleBase.tag("RadialGaugeTypeQuatre");
    public static register(): any {
        window.customElements.define(this.htmlTagName, RadialGaugeTypeQuatre); return this;
    }
