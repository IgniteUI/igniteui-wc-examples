...
export class BulletGraphTypeFilled extends SampleBase {

    public static htmlTagName: string = SampleBase.tag("BulletGraphTypeFilled");
    public static register(): any {
        window.customElements.define(this.htmlTagName, BulletGraphTypeFilled); return this;
    }
