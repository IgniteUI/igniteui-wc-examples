import { WorldLocations2 } from "./WorldLocations2";
import { WorldUtils2 } from "./WorldUtils2"

export class WorldConnections2 {
    ...
    public static init(): void {
        ...
        const cities: any[] = WorldLocations2.getAll();
        // cities.sort(this.comparePopulation);
        WorldUtils2.sortBy(cities, 'pop');
        ...
        for (let i = 0; i < cities.length; i++) {
            ...
            for (let ii = 0; ii < cities.length; ii++)
            {
                ...
                {
                    let flight = WorldUtils2.getFlight(origin, dest);
                    ...
                    if (routeIsValid && distanceIsValid && trafficIsValid) {
                        ...
                        // let returnFlight = WorldUtils2.getFlight(dest, origin);
