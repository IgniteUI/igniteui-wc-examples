import { defineComponents, IgcAvatarComponent, IgcBadgeComponent, IgcIconComponent, IgcStepComponent, IgcStepperComponent, registerIconFromText } from 'igniteui-webcomponents';
import 'igniteui-webcomponents/themes/light/bootstrap.css';
import './index.css';

defineComponents(IgcBadgeComponent, IgcAvatarComponent, IgcIconComponent, IgcStepperComponent, IgcStepComponent);
...
export class BadgeOutlined {
  constructor() {
    const stepper = document.querySelector('igc-stepper') as IgcStepperComponent;
