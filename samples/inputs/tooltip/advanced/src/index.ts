import { defineComponents, IgcTooltipComponent, IgcAvatarComponent, IgcListComponent, registerIconFromText, IgcIconComponent, IgcBadgeComponent, IgcButtonComponent, IgcCardComponent} from 'igniteui-webcomponents';
import { IgcCategoryChartComponent, IgcCategoryChartModule } from 'igniteui-webcomponents-charts';
import { IncomeTaxes } from './IncomeTaxes';
import { ModuleManager } from 'igniteui-webcomponents-core';
import 'igniteui-webcomponents/themes/light/material.css';
import './index.css';

defineComponents(IgcTooltipComponent, IgcAvatarComponent, IgcListComponent, IgcIconComponent, IgcBadgeComponent, IgcButtonComponent, IgcCardComponent);
...
export class AdvancedTooltips {
  ...
  constructor() {
        ...
        this._bind = () => {
            chart.dataSource = this.incomeTaxes;
        }
        this._bind();
