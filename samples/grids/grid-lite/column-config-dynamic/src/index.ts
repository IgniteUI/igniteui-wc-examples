...
export class Sample {
    ...
    private gridLite: IgcGridLite<ProductInfo>;
    ...
    protected rating: (params: any) => HTMLElement = (params: any) => {
    ...
    constructor() {
        ...
        this.formattersSwitch.addEventListener('igcChange', (e: CustomEvent<IgcCheckboxChangeEventArgs>) => {
              this.gridLite.getColumn('price').cellTemplate = e.detail.checked ? this.format : undefined; 
              this.gridLite.getColumn('total').cellTemplate = e.detail.checked ? this.format : undefined;
              //this.gridLite.columns = [...this.gridLite.columns];
        });
