        ...
        const toolbarTemplate = html`
            <igc-grid-toolbar>
                <igc-grid-toolbar-actions>
                    ${this._advancedFiltering ? html`<igc-grid-toolbar-advanced-filtering></igc-grid-toolbar-advanced-filtering>` : ''}
                    ${this._hiding ? html`<igc-grid-toolbar-hiding></igc-grid-toolbar-hiding>` : ''}
                    ${this._pinning ? html`<igc-grid-toolbar-pinning></igc-grid-toolbar-pinning>` : ''}
                    ${this._exporter ? html`<igc-grid-toolbar-exporter></igc-grid-toolbar-exporter>` : ''}
                </igc-grid-toolbar-actions>
            </igc-grid-toolbar>
        `;
