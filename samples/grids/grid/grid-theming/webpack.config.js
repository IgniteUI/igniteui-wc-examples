    ...
    return {
        ...
        module: {
            rules: [
                ...
                {
                    test: /\.css$/,
                    // Exclude grids theme CSS from the default eager style-loader rule.
                    // Theme CSS is imported via inline lazy style-loader (!!style-loader?{"injectType":"lazyStyleTag"}!css-loader!...)
                    // to enable runtime switching. Without this exclude, theme files could be
                    // double-injected if referenced elsewhere.
                    exclude: /igniteui-webcomponents-grids[\\/]grids[\\/]themes/,
                    sideEffects: true,
