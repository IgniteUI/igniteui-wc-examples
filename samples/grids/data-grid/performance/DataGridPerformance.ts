...
<div class="sample-container">
    ...
    row-height="40"
    default-column-min-width="80"
    column-showing-animation-mode="Auto"
    column-hiding-animation-mode="Auto">

    <igc-text-column property-path="FirstName" header-text="First Name" width="*>125"></igc-text-column>
    <igc-text-column property-path="LastName" header-text="Last Name" width="*>125"></igc-text-column>
    <igc-text-column property-path="Territory" width="*>115"></igc-text-column>
    <igc-numeric-column property-path="YearToDateSales"
        header-text="YTD Sales" width="*>120" positive-prefix="$"
        show-grouping-separator="true">
    </igc-numeric-column>

    <igc-template-column id="avgSaleTemplateColumn" property-path="AvgSale"
        header-text="Avg. Sale"
        width="*>125"
    ...
    <igc-template-column id="percentChangeTemplateColumn" property-path="PercentChange" width="*>135"
        horizontal-alignment="right" header-text="Change (%)"
        cellStyleKeyRequested={this.onPricePercentStyleKey}
        cellUpdating={this.onPricePercentCellUpdating}>
    </igc-template-column>

    <igc-date-time-column property-path="DateValue" header-text="Date" width="*>120" >
...
export class DataGridPerformance extends SampleBase {

    public static htmlTagName: string = SampleBase.tag("DataGridPerformance");
    public static register(): any {
        window.customElements.define(this.htmlTagName, DataGridPerformance); return this;
    }
