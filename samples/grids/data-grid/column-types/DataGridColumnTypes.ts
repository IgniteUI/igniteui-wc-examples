...
<div class="sample-container">
    <igc-data-grid
        ...
        property-path="Sales" header-text="Sales" horizontal-alignment="left"
        ...
        <igc-text-column property-path="Income" width="*>120"></igc-text-column>
...
export class DataGridColumnTypes extends SampleBase {

    public static htmlTagName: string = SampleBase.tag("DataGridColumnTypes");
    public static register(): any {
        window.customElements.define(this.htmlTagName, DataGridColumnTypes); return this;
    }
