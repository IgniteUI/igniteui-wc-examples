...
import { IgcDataChartToolbarModule, IgcNumberAbbreviatorModule, IgcDataChartCategoryeModule, IgcDataChartCoreModule, IgcDataChartInteractivityModule, IgcDataChartAnnotationModule } from 'igniteui-webcomponents-charts';
import { ComponentRenderer, PropertyEditorPanelDescriptionModule, ToolbarDescriptionModule, DataChartToolbarDescriptionModule, NumberAbbreviatorDescriptionModule, DataChartCategoryeDescriptionModule, DataChartCoreDescriptionModule, DataChartInteractivityDescriptionModule, DataChartAnnotationDescriptionModule } from 'igniteui-webcomponents-core';
...
export class Sample {
    ...
    private baseTheme: IgcPropertyEditorPropertyDescriptionComponent
    ...
    constructor() {
        ...
        var baseTheme = this.baseTheme = document.getElementById('BaseTheme') as IgcPropertyEditorPropertyDescriptionComponent;
