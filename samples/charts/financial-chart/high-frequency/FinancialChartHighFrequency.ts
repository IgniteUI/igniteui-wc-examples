...
<div class="sample-container">
    <div class="options">
        ...
        <label class="optionValue" id="refeshInfoLabel">
        </label>
        <input class="slider" id="refreshSlider" type="range"
            min="5" max="1000">
        </input>
        <label class="optionLabel">Data Points: </label>
        <label class="optionValue" id="dataInfoLabel" >
        </label>
        <input class="slider" id="dataPointsSlider" type="range"
            min="10000" max="100000" step="1000">
        </input>
        <button id="genDataBtn">Generate Data</button>
        <label class="optionItem">
            <input id="scalingRatio" type="checkbox"></input> Optimize Scaling
        </label>
        <span id="fpsSpan" class="optionLabel"></span>
    </div>
...
export class FinancialChartHighFrequency extends SampleBase {

    public static htmlTagName: string = SampleBase.tag("FinancialChartHighFrequency");
    public static register(): any {
        window.customElements.define(this.htmlTagName, FinancialChartHighFrequency); return this;
    }
