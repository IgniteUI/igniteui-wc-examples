...
<div class="sample-container">
    <igc-category-chart id="chart"
        ...
        y-axis-major-stroke="gray"
        y-axis-major-stroke-thickness="1"
        y-axis-minor-interval="1"
        y-axis-minor-stroke="gray"
        y-axis-minor-stroke-thickness="0"
        x-axis-gap="0.45"
        x-axis-overlap="1">
    </igc-category-chart>

    <igc-legend id="legend" orientation="Horizontal" height="40px"></igc-legend>
</div>
`;

export class CategoryChartStackColumns extends SampleBase {

    public static htmlTagName: string = SampleBase.tag("CategoryChartStackColumns");
    public static register(): any {
        window.customElements.define(this.htmlTagName, CategoryChartStackColumns); return this;
    }
