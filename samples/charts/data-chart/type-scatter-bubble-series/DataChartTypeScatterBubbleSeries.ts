...
export class DataChartTypeScatterBubbleSeries extends SampleBase {

    public static htmlTagName: string = SampleBase.tag("DataChartTypeScatterBubbleSeries");
    public static register(): any {
        window.customElements.define(this.htmlTagName, DataChartTypeScatterBubbleSeries); return this;
    }
