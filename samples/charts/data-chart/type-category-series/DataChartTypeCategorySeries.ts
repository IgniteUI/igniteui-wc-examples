...
<div class="sample-container">
    <div class="options">
        <span class="option-label">Type of Category Series: </span>
...
export class DataChartTypeCategorySeries extends SampleBase {

    public static htmlTagName: string = SampleBase.tag("DataChartTypeCategorySeries");
    public static register(): any {
        window.customElements.define(this.htmlTagName, DataChartTypeCategorySeries); return this;
    }
