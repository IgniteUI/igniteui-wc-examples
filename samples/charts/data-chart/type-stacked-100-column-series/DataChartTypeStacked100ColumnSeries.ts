...
export class DataChartTypeStacked100ColumnSeries extends SampleBase {

    public static htmlTagName: string = SampleBase.tag("DataChartTypeStacked100ColumnSeries");
    public static register(): any {
        window.customElements.define(this.htmlTagName, DataChartTypeStacked100ColumnSeries); return this;
    }
