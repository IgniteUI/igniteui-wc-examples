...
<div class="sample-container">
    <div class="options">
        <span class="option-item">Series Type:</span>
...
export class DataChartAxisTypes extends SampleBase {

    public static htmlTagName: string = SampleBase.tag("DataChartAxisTypes");
    public static register(): any {
        window.customElements.define(this.htmlTagName, DataChartAxisTypes); return this;
    }
