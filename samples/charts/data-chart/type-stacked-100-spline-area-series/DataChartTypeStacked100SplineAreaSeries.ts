...
export class DataChartTypeStacked100SplineAreaSeries extends SampleBase {

    public static htmlTagName: string = SampleBase.tag("DataChartTypeStacked100SplineAreaSeries");
    public static register(): any {
        window.customElements.define(this.htmlTagName, DataChartTypeStacked100SplineAreaSeries); return this;
    }
