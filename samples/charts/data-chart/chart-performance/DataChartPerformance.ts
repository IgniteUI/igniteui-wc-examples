...
<div class="sample-container">
    <div class="options">
        <label class="option-label">Data Points: </label>
        <label class="option-value" id="dataInfo">
        </label>
        ...
        <label class="option-item">
            <input type="checkbox" id="scaleRatio"
            onChange={this.onScalingRatioChanged}></input> Optimize Scaling
        </label>
        <span id="fps" className="optionLabel"></span>
    </div>
...
export class DataChartPerformance extends SampleBase {

    public static htmlTagName: string = SampleBase.tag("DataChartPerformance");
    public static register(): any {
        window.customElements.define(this.htmlTagName, DataChartPerformance); return this;
    }
    ...
    connectedCallback() {
        ...
        this.dataInfo.textContent = SharedData.toShortString(this.dataPoints);
