...
export class DataChartTypeCategoryColumnSeries extends SampleBase {

    public static htmlTagName: string = SampleBase.tag("DataChartTypeCategoryColumnSeries");
    public static register(): any {
        window.customElements.define(this.htmlTagName, DataChartTypeCategoryColumnSeries); return this;
    }
