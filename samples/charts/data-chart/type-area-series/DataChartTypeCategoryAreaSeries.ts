...
export class DataChartTypeCategoryAreaSeries extends SampleBase {

    public static htmlTagName: string = SampleBase.tag("DataChartTypeCategoryAreaSeries");
    public static register(): any {
        window.customElements.define(this.htmlTagName, DataChartTypeCategoryAreaSeries); return this;
    }
