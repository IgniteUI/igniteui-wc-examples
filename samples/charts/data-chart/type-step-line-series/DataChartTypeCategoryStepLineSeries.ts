...
export class DataChartTypeCategoryStepLineSeries extends SampleBase {

    public static htmlTagName: string = SampleBase.tag("DataChartTypeCategoryStepLineSeries");
    public static register(): any {
        window.customElements.define(this.htmlTagName, DataChartTypeCategoryStepLineSeries); return this;
    }
