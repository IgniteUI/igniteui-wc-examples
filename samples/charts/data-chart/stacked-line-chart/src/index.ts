...
import { IgcLegendComponent, IgcDataChartComponent, IgcCategoryXAxisComponent, IgcNumericYAxisComponent, IgcStackedLineSeriesComponent, IgcStackedFragmentSeriesComponent } from 'igniteui-webcomponents-charts';
...
export class Sample {
    ...
    constructor() {
        ...
        stackedLineSeries.dataSource = this.data
    }
