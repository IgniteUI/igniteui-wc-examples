...
export class DataChartTypeRadialColumnSeries extends SampleBase {

    public static htmlTagName: string = SampleBase.tag("DataChartTypeRadialColumnSeries");
    public static register(): any {
        window.customElements.define(this.htmlTagName, DataChartTypeRadialColumnSeries); return this;
    }
