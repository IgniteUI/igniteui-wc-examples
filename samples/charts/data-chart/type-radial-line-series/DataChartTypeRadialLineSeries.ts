...
export class DataChartTypeRadialLineSeries extends SampleBase {

    public static htmlTagName: string = SampleBase.tag("DataChartTypeRadialLineSeries");
    public static register(): any {
        window.customElements.define(this.htmlTagName, DataChartTypeRadialLineSeries); return this;
    }
