...
export class DataChartTypeCategoryWaterfallSeries extends SampleBase {

    public static htmlTagName: string = SampleBase.tag("DataChartTypeCategoryWaterfallSeries");
    public static register(): any {
        window.customElements.define(this.htmlTagName, DataChartTypeCategoryWaterfallSeries); return this;
    }
