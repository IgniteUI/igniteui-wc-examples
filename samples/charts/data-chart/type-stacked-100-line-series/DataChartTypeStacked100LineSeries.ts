...
export class DataChartTypeStacked100LineSeries extends SampleBase {

    public static htmlTagName: string = SampleBase.tag("DataChartTypeStacked100LineSeries");
    public static register(): any {
        window.customElements.define(this.htmlTagName, DataChartTypeStacked100LineSeries); return this;
    }
