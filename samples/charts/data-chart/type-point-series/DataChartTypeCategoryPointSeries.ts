...
export class DataChartTypeCategoryPointSeries extends SampleBase {

    public static htmlTagName: string = SampleBase.tag("DataChartTypeCategoryPointSeries");
    public static register(): any {
        window.customElements.define(this.htmlTagName, DataChartTypeCategoryPointSeries); return this;
    }
