...
export class DataChartTypeCategoryLineSeries extends SampleBase {

    public static htmlTagName: string = SampleBase.tag("DataChartTypeCategoryLineSeries");
    public static register(): any {
        window.customElements.define(this.htmlTagName, DataChartTypeCategoryLineSeries); return this;
    }
