...
export class DataChartTypePolarSplineSeries extends SampleBase {

    public static htmlTagName: string = SampleBase.tag("DataChartTypePolarSplineSeries");
    public static register(): any {
        window.customElements.define(this.htmlTagName, DataChartTypePolarSplineSeries); return this;
    }
