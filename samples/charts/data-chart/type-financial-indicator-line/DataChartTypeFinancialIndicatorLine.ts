...
export class DataChartTypeFinancialIndicatorLine extends SampleBase {

    public static htmlTagName: string = SampleBase.tag("DataChartTypeFinancialIndicatorLine");
    public static register(): any {
        window.customElements.define(this.htmlTagName, DataChartTypeFinancialIndicatorLine); return this;
    }
