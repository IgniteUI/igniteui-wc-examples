...
<div class="sample-container">
    ...
    <igc-scatter-spline-series id="series2"
        marker-type="Circle"
        x-axis-name="xAxis"
        y-axis-name="yAxis"
        x-member-path="Population"
...
export class DataChartTypeScatterSplineSeries extends SampleBase {

    public static htmlTagName: string = SampleBase.tag("DataChartTypeScatterSplineSeries");
    public static register(): any {
        window.customElements.define(this.htmlTagName, DataChartTypeScatterSplineSeries); return this;
    }
