...
<div class="sample-container">
    <div class="options">
        <span class="optionLabel">Type of Category Series: </span>
...
export class DataChartTypeStackedSeries extends SampleBase {

    public static htmlTagName: string = SampleBase.tag("DataChartTypeStackedSeries");
    public static register(): any {
        window.customElements.define(this.htmlTagName, DataChartTypeStackedSeries); return this;
    }
