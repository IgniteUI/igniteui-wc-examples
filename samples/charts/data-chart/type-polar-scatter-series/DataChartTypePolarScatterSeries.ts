...
export class DataChartTypePolarScatterSeries extends SampleBase {

    public static htmlTagName: string = SampleBase.tag("DataChartTypePolarScatterSeries");
    public static register(): any {
        window.customElements.define(this.htmlTagName, DataChartTypePolarScatterSeries); return this;
    }
