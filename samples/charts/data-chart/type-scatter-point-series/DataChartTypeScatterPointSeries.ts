...
export class DataChartTypeScatterPointSeries extends SampleBase {

    public static htmlTagName: string = SampleBase.tag("DataChartTypeScatterPointSeries");
    public static register(): any {
        window.customElements.define(this.htmlTagName, DataChartTypeScatterPointSeries); return this;
    }
