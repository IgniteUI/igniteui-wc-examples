...
export class DataChartTypeFinancialIndicatorArea extends SampleBase {

    public static htmlTagName: string = SampleBase.tag("DataChartTypeFinancialIndicatorArea");
    public static register(): any {
        window.customElements.define(this.htmlTagName, DataChartTypeFinancialIndicatorArea); return this;
    }
