...
<div class="sample-container">
    <div class="options">
        ...
        <label class="option-item"><input type="checkbox" id="callouts"></input>Callouts </label>
        <label class="option-item"><input type="checkbox" id="finalValue"></input>Final Value</label>
        <label class="option-item"><input type="checkbox" id="crosshairs"></input>Crosshairs</label>
        <!-- <label class="option-item"><input type="checkbox" id="valueOverlay"></input>Value Overlay </label> -->
    </div>
    ...
    <div class="chart" style="height: calc(100% - 45px)">
        ...
        is-vertical-zoom-enabled="true">
            <igc-category-x-axis id="xAxis" name="xAxis" interval="1">
            </igc-category-x-axis>
            <igc-numeric-y-axis id="yAxis" name="yAxis"
                minimum-value="70"
                maximum-value="110"
                label-location="OutsideRight">
            </igc-numeric-y-axis>
            <igc-column-series id="series1" name="series1"
                x-axis-name="xAxis"
                y-axis-name="yAxis"
...
export class DataChartSeriesAnnotations extends SampleBase {

    public static htmlTagName: string = SampleBase.tag("DataChartSeriesAnnotations");
    public static register(): any {
        window.customElements.define(this.htmlTagName, DataChartSeriesAnnotations); return this;
    }
