...
<div class="sample-container">
    <div class="options">
        <span class="option-label">Type of Scatter Series: </span>
...
export class DataChartTypeScatterSeries extends SampleBase {

    public static htmlTagName: string = SampleBase.tag("DataChartTypeScatterSeries");
    public static register(): any {
        window.customElements.define(this.htmlTagName, DataChartTypeScatterSeries); return this;
    }
