...
export class DataChartTypeRadialPieSeries extends SampleBase {

    public static htmlTagName: string = SampleBase.tag("DataChartTypeRadialPieSeries");
    public static register(): any {
        window.customElements.define(this.htmlTagName, DataChartTypeRadialPieSeries); return this;
    }
