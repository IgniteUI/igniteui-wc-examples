...
export class DataChartTypePolarSplineAreaSeries extends SampleBase {

    public static htmlTagName: string = SampleBase.tag("DataChartTypePolarSplineAreaSeries");
    public static register(): any {
        window.customElements.define(this.htmlTagName, DataChartTypePolarSplineAreaSeries); return this;
    }
