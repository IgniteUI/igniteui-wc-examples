...
export class DataChartTypeFinancialOhlcSeries extends SampleBase {

    public static htmlTagName: string = SampleBase.tag("DataChartTypeFinancialOhlcSeries");
    public static register(): any {
        window.customElements.define(this.htmlTagName, DataChartTypeFinancialOhlcSeries); return this;
    }
