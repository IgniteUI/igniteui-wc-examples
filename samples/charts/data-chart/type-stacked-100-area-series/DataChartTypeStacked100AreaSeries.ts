...
export class DataChartTypeStacked100AreaSeries extends SampleBase {

    public static htmlTagName: string = SampleBase.tag("DataChartTypeStacked100AreaSeries");
    public static register(): any {
        window.customElements.define(this.htmlTagName, DataChartTypeStacked100AreaSeries); return this;
    }
