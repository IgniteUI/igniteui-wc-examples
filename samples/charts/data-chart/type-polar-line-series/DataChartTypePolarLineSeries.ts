...
export class DataChartTypePolarLineSeries extends SampleBase {

    public static htmlTagName: string = SampleBase.tag("DataChartTypePolarLineSeries");
    public static register(): any {
        window.customElements.define(this.htmlTagName, DataChartTypePolarLineSeries); return this;
    }
