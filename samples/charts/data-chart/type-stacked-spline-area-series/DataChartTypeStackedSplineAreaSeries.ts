...
export class DataChartTypeStackedSplineAreaSeries extends SampleBase {

    public static htmlTagName: string = SampleBase.tag("DataChartTypeStackedSplineAreaSeries");
    public static register(): any {
        window.customElements.define(this.htmlTagName, DataChartTypeStackedSplineAreaSeries); return this;
    }
