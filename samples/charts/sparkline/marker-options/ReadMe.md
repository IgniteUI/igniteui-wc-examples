...
This folder contains implementation of Web Components application with example of Sparkline Markers.
...
<html lang="en" xmlns="http://www.w3.org/1999/xhtml">
    <body>
        <a target="_blank" href="https://codesandbox.io/s/github/IgniteUI/igniteui-webcomponents-examples/tree/master/samples/charts/sparkline/marker-options?fontsize=14&hidenavigation=1&theme=dark&view=preview&file=/src/{SampleFile}" rel="noopener noreferrer">
...
cd ../samples/charts/sparkline/marker-options
```
