...
export class SparklineDisplayColumn extends SampleBase {

    public static htmlTagName: string = SampleBase.tag("SparklineDisplayColumn");
    public static register(): any {
        window.customElements.define(this.htmlTagName, SparklineDisplayColumn); return this;
    }
