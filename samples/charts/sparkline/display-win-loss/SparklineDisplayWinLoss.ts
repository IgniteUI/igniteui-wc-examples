...
<div class="sample-container">
    <igc-sparkline id="chart1" class="sparkline"
        height="calc(30% - 25px)"
        width="100%"
        display-type="WinLoss"
        value-member-path="Value1"></igc-sparkline>
    <igc-sparkline id="chart2" class="sparkline"
        height="calc(30% - 25px)"
        width="100%"
        display-type="WinLoss"
        value-member-path="Value2"></igc-sparkline>
    <igc-sparkline id="chart3" class="sparkline"
        height="calc(30% - 25px)"
        width="100%"
        display-type="WinLoss"
        value-member-path="Value1"></igc-sparkline>
...
export class SparklineDisplayWinLoss extends SampleBase {

    public static htmlTagName: string = SampleBase.tag("SparklineDisplayWinLoss");
    public static register(): any {
        window.customElements.define(this.htmlTagName, SparklineDisplayWinLoss); return this;
    }
