...
export class SparklineDisplayLines extends SampleBase {

    public static htmlTagName: string = SampleBase.tag("SparklineDisplayLines");
    public static register(): any {
        window.customElements.define(this.htmlTagName, SparklineDisplayLines); return this;
    }
