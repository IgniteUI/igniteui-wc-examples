...
<div class="sample-container">
    <label id="label" class="sample-label"> Exploded Slices: None</label>
...
export class DoughnutChartExplosion extends SampleBase {

    public static htmlTagName: string = SampleBase.tag("DoughnutChartExplosion");
    public static register(): any {
        window.customElements.define(this.htmlTagName, DoughnutChartExplosion); return this;
    }
