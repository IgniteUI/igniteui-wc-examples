...
import { SampleScatterStats } from "../data-chart/utilities/SampleScatterStats";
...
<div class="sample-container">
    <div id="container" style="width: calc(100% - 10px); height: calc(100% - 10px)">
        <igc-data-chart id="mainChart"
            width="100%" height="calc(100% - 160px)"
            title-top-margin="10"
            chart-title="World GDP vs Population"
            is-horizontal-zoom-enabled="true"
            is-vertical-zoom-enabled="false">

                <igc-numeric-x-axis
                    name="mainXAxis" id="mainXAxis"
                    is-logarithmic="true"
                    abbreviate-large-numbers="true"
                    title="Population">
                </igc-numeric-x-axis>
                <igc-numeric-y-axis
                    name="mainYAxis" id="mainYAxis"
                    is-logarithmic="true"
                    abbreviate-large-numbers="true"
        ...
        <div style="width: calc(100% - 70px);
            ...
            <div style="width: 100%; height: 160px; position: absolute; top: 0px; left: 0px">
                <igc-data-chart
                    ...
                    is-vertical-zoom-enabled="true" >
                        <igc-numeric-x-axis id="zoomXAxis" name="zoomXAxis"
                            is-logarithmic="true"
                            abbreviate-large-numbers="true"
                            label-visibility="collapsed">
                        </igc-numeric-x-axis>
                        <igc-numeric-y-axis id="zoomYAxis" name="zoomYAxis"
                            is-logarithmic="true"
                            abbreviate-large-numbers="true"
                            label-visibility="collapsed" >
                        </igc-numeric-x-axis>
            ...
            <div style="width: 100%; height: 160px; position: absolute; top: 0px; left: 0px">
                <igc-zoom-slider id="zoomSlider"
                    width="100%"
                    height="100%"
                    are-thumb-callouts-enabled="true" >
                </igc-zoom-slider
            </div>
        </div>
    </div>
...
export class ZoomSliderOverview extends SampleBase {

    public static htmlTagName: string = SampleBase.tag("ZoomSliderOverview");
    public static register(): any {
        window.customElements.define(this.htmlTagName, ZoomSliderOverview); return this;
    }
