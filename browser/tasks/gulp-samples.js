...
function updateIG(cb) {
    ...
    let packageUpgrades = [
        ...
        { name: "@infragistics/igniteui-webcomponents-core"                     , version: "22.2.58" },
        { name: "@infragistics/igniteui-webcomponents-charts"                   , version: "22.2.58" },
        { name: "@infragistics/igniteui-webcomponents-excel"                    , version: "22.2.58" },
        { name: "@infragistics/igniteui-webcomponents-gauges"                   , version: "22.2.58" },
        { name: "@infragistics/igniteui-webcomponents-grids"                    , version: "22.2.58" },
        { name: "@infragistics/igniteui-webcomponents-inputs"                   , version: "22.2.58" },
        { name: "@infragistics/igniteui-webcomponents-layouts"                  , version: "22.2.58" },
        { name: "@infragistics/igniteui-webcomponents-maps"                     , version: "22.2.58" },
        { name: "@infragistics/igniteui-webcomponents-spreadsheet-chart-adapter", version: "22.2.58" },
        { name: "@infragistics/igniteui-webcomponents-spreadsheet"              , version: "22.2.58" },
        { name: "@infragistics/igniteui-webcomponents-datasources"              , version: "22.2.58" },
