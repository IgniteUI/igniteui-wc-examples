...
function updateIG(cb) {
    ...
    let packageUpgrades = [
        ...
        { name: "@infragistics/igniteui-webcomponents-core"                     , version: "24.1.58" },
        { name: "@infragistics/igniteui-webcomponents-charts"                   , version: "24.1.58" },
        { name: "@infragistics/igniteui-webcomponents-excel"                    , version: "24.1.58" },
        { name: "@infragistics/igniteui-webcomponents-gauges"                   , version: "24.1.58" },
        { name: "@infragistics/igniteui-webcomponents-grids"                    , version: "24.1.58" },
        { name: "@infragistics/igniteui-webcomponents-inputs"                   , version: "24.1.58" },
        { name: "@infragistics/igniteui-webcomponents-layouts"                  , version: "24.1.58" },
        { name: "@infragistics/igniteui-webcomponents-maps"                     , version: "24.1.58" },
        { name: "@infragistics/igniteui-webcomponents-spreadsheet-chart-adapter", version: "24.1.58" },
        { name: "@infragistics/igniteui-webcomponents-spreadsheet"              , version: "24.1.58" },
        { name: "@infragistics/igniteui-webcomponents-datasources"              , version: "24.1.58" },
