...
function updateIG(cb) {
    ...
    let packageUpgrades = [
        ...
        { name: "igniteui-webcomponents-core"                     , version: "4.7.2-beta.1" },
        { name: "igniteui-webcomponents-charts"                   , version: "4.7.2-beta.1" },
        { name: "igniteui-webcomponents-excel"                    , version: "4.7.2-beta.1" },
        { name: "igniteui-webcomponents-gauges"                   , version: "4.7.2-beta.1" },
        { name: "igniteui-webcomponents-grids"                    , version: "4.7.2-beta.1" },
        { name: "igniteui-webcomponents-inputs"                   , version: "4.7.2-beta.1" },
        { name: "igniteui-webcomponents-layouts"                  , version: "4.7.2-beta.1" },
        { name: "igniteui-webcomponents-maps"                     , version: "4.7.2-beta.1" },
        { name: "igniteui-webcomponents-spreadsheet-chart-adapter", version: "4.7.2-beta.1" },
        { name: "igniteui-webcomponents-spreadsheet"              , version: "4.7.2-beta.1" },
        { name: "igniteui-webcomponents-datasources"              , version: "4.7.2-beta.1" },
