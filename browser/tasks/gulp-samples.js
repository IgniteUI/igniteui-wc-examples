...
function updateIG(cb) {
    ...
    let packageUpgrades = [
        ...
        { version: "5.5.0-beta.0", name: "igniteui-webcomponents-core" },
        ...
        { version: "5.5.0-beta.0", name: "igniteui-webcomponents-maps" },
        { version: "5.5.0-beta.0", name: "igniteui-webcomponents-spreadsheet-chart-adapter" },
        { version: "5.5.0-beta.0", name: "igniteui-webcomponents-spreadsheet" },
        { version: "5.5.0-beta.0", name: "igniteui-webcomponents-datasources" },
        { version: "5.5.0-beta.0", name: "igniteui-webcomponents-dashboards" },
