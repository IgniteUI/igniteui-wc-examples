...
function updateIG(cb) {
    ...
    let packageUpgrades = [
        ...
        { version: "5.1.1-beta.0", name: "igniteui-webcomponents-core" },
        { version: "5.1.1-beta.0", name: "igniteui-webcomponents-charts" },
        { version: "5.1.1-beta.0", name: "igniteui-webcomponents-excel" },
        { version: "5.1.1-beta.0", name: "igniteui-webcomponents-gauges" },
        { version: "5.1.1-beta.0", name: "igniteui-webcomponents-grids" },
        { version: "5.1.1-beta.0", name: "igniteui-webcomponents-inputs" },
        { version: "5.1.1-beta.0", name: "igniteui-webcomponents-layouts" },
        { version: "5.1.1-beta.0", name: "igniteui-webcomponents-maps" },
        { version: "5.1.1-beta.0", name: "igniteui-webcomponents-spreadsheet-chart-adapter" },
        { version: "5.1.1-beta.0", name: "igniteui-webcomponents-spreadsheet" },
        { version: "5.1.1-beta.0", name: "igniteui-webcomponents-datasources" },
