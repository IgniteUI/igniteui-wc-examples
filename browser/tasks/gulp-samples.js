...
function updateIG(cb) {
    ...
    let packageUpgrades = [
        ...
        { name: "@infragistics/igniteui-webcomponents-core"                     , version: "23.2.209" },
        { name: "@infragistics/igniteui-webcomponents-charts"                   , version: "23.2.209" },
        { name: "@infragistics/igniteui-webcomponents-excel"                    , version: "23.2.209" },
        { name: "@infragistics/igniteui-webcomponents-gauges"                   , version: "23.2.209" },
        { name: "@infragistics/igniteui-webcomponents-grids"                    , version: "23.2.209" },
        { name: "@infragistics/igniteui-webcomponents-inputs"                   , version: "23.2.209" },
        { name: "@infragistics/igniteui-webcomponents-layouts"                  , version: "23.2.209" },
        { name: "@infragistics/igniteui-webcomponents-maps"                     , version: "23.2.209" },
        { name: "@infragistics/igniteui-webcomponents-spreadsheet-chart-adapter", version: "23.2.209" },
        { name: "@infragistics/igniteui-webcomponents-spreadsheet"              , version: "23.2.209" },
        { name: "@infragistics/igniteui-webcomponents-datasources"              , version: "23.2.209" },
