...
function updateIG(cb) {
    ...
    let packageUpgrades = [
        ...
        { version: "25.1.3", name: "@infragistics/igniteui-webcomponents-core" },
        { version: "25.1.3", name: "@infragistics/igniteui-webcomponents-charts" },
        { version: "25.1.3", name: "@infragistics/igniteui-webcomponents-excel" },
        { version: "25.1.3", name: "@infragistics/igniteui-webcomponents-gauges" },
        { version: "6.0.1", name: "igniteui-webcomponents-grids" },
        { version: "25.1.3", name: "@infragistics/igniteui-webcomponents-inputs" },
        { version: "25.1.3", name: "@infragistics/igniteui-webcomponents-layouts" },
        { version: "25.1.3", name: "@infragistics/igniteui-webcomponents-maps" },
        { version: "25.1.3", name: "@infragistics/igniteui-webcomponents-spreadsheet-chart-adapter" },
        { version: "25.1.3", name: "@infragistics/igniteui-webcomponents-spreadsheet" },
        { version: "25.1.3", name: "@infragistics/igniteui-webcomponents-datasources" },
        { version: "25.1.3", name: "@infragistics/igniteui-webcomponents-dashboards" },
