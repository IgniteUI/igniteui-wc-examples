...
function updateIG(cb) {
    ...
    let packageUpgrades = [
        ...
        { version: "6.3.1-beta.0", name: "igniteui-webcomponents-core" },
        { version: "6.3.1-beta.0", name: "igniteui-webcomponents-charts" },
        { version: "6.3.1-beta.0", name: "igniteui-webcomponents-excel" },
        { version: "6.3.1-beta.0", name: "igniteui-webcomponents-gauges" },
        { version: "6.3.1-beta.0", name: "igniteui-webcomponents-data-grids" },
        { version: "6.3.1-beta.0", name: "igniteui-webcomponents-inputs" },
        { version: "6.3.1-beta.0", name: "igniteui-webcomponents-layouts" },
        { version: "6.3.1-beta.0", name: "igniteui-webcomponents-maps" },
        { version: "6.3.1-beta.0", name: "igniteui-webcomponents-spreadsheet-chart-adapter" },
        { version: "6.3.1-beta.0", name: "igniteui-webcomponents-spreadsheet" },
        { version: "6.3.1-beta.0", name: "igniteui-webcomponents-datasources" },
        { version: "6.3.1-beta.0", name: "igniteui-webcomponents-dashboards" },
