...
const THEME_CSS: Record<string, CssLoader[]> = {
  'light:material': [
    () => import('igniteui-webcomponents-grids/grids/themes/light/material.css?inline'),
    () => import('igniteui-webcomponents/themes/light/material.css?inline'),
  ],
  'light:fluent': [
    () => import('igniteui-webcomponents-grids/grids/themes/light/fluent.css?inline'),
    () => import('igniteui-webcomponents/themes/light/fluent.css?inline'),
  ],
  'light:bootstrap': [
    () => import('igniteui-webcomponents-grids/grids/themes/light/bootstrap.css?inline'),
    () => import('igniteui-webcomponents/themes/light/bootstrap.css?inline'),
  ],
  'light:indigo': [
    () => import('igniteui-webcomponents-grids/grids/themes/light/indigo.css?inline'),
    () => import('igniteui-webcomponents/themes/light/indigo.css?inline'),
  ],
  'dark:material': [
    () => import('igniteui-webcomponents-grids/grids/themes/dark/material.css?inline'),
    () => import('igniteui-webcomponents/themes/dark/material.css?inline'),
  ],
  'dark:fluent': [
    () => import('igniteui-webcomponents-grids/grids/themes/dark/fluent.css?inline'),
    () => import('igniteui-webcomponents/themes/dark/fluent.css?inline'),
  ],
  'dark:bootstrap': [
    () => import('igniteui-webcomponents-grids/grids/themes/dark/bootstrap.css?inline'),
    () => import('igniteui-webcomponents/themes/dark/bootstrap.css?inline'),
  ],
  'dark:indigo': [
    () => import('igniteui-webcomponents-grids/grids/themes/dark/indigo.css?inline'),
...
function writeSheets(css: string[]): void {
  css.forEach((text, i) => {
    ...
    el.textContent = text;
    // Re-append on every swap so the override stays last in the cascade, ahead
    // of the theme sheet the sample's own lazily-loaded chunk imports.
...
function watchSystemMode(): void {
  ...
  query.addEventListener('change', () => {
    if (selected?.mode === 'system') applyTheme(selected.theme, selected.mode);
  });
}
