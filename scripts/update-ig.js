...
const packageUpgrades = [
    ...
    { name: 'igniteui-webcomponents-core',                    version: '7.1.0-beta.1'   },
    { name: 'igniteui-webcomponents-charts',                  version: '7.1.0-beta.1'   },
    { name: 'igniteui-webcomponents-excel',                   version: '7.1.0-beta.1'   },
    { name: 'igniteui-webcomponents-gauges',                  version: '7.1.0-beta.1'   },
    { name: 'igniteui-webcomponents-data-grids',              version: '7.1.0-beta.1'   },
    { name: 'igniteui-webcomponents-inputs',                  version: '7.1.0-beta.1'   },
    { name: 'igniteui-webcomponents-layouts',                 version: '7.1.0-beta.1'   },
    { name: 'igniteui-webcomponents-maps',                    version: '7.1.0-beta.1'   },
    { name: 'igniteui-webcomponents-spreadsheet-chart-adapter', version: '7.1.0-beta.1' },
    { name: 'igniteui-webcomponents-spreadsheet',             version: '7.1.0-beta.1'   },
    { name: 'igniteui-webcomponents-datasources',             version: '7.1.0-beta.1'   },
    { name: 'igniteui-webcomponents-dashboards',              version: '7.1.0-beta.1'   },
